    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Othercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Othercoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and othercoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Othercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Othercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Othercoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Othercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Othercoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a othercoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Othercoin Core help message to get a list with possible Othercoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Othercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Othercoin network", "", count));
}
...
{
    QString strTitle = tr("Othercoin Core"); // default title
    ...
    // Append title to "Othercoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

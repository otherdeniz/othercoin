    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Othercoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Othercoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  othercoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Othercoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 OTC, 0.1 OTC, 1 OTC and 10 OTC -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://othercoincoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://othercoincoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Othercoin Core is shutting down...") + "<br /><br />" +

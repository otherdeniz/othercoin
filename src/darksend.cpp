...
{
    if(fLiteMode) return; // ignore all Othercoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Othercoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("othercoin-privatesend");

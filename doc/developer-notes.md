...
Othercoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Othercoin Core, where everyone uses
...
pay attention to for reviewers of Othercoin Core code.

General Othercoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Othercoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
Only requiring some minor changes is othercoin.cpp.
...
Changes to othercoin.cpp
----------------------
othercoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
